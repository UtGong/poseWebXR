...
{
    public class LineGraphWithSlider : MonoBehaviour
    {
        ...
        public void AddDataPoint()
        {
            ...
            if (currentIndex < dataPoints.Count)
            {
                ...
                GameObject p = CreatePoint(new Vector2(xPosition, yPosition), pointColor);
        ...
        private void OnSliderValueChanged(float value)
        {
            ...
            {
                // Slider is being slid to the right
                Debug.Log("Slider is moving to the right");
                AddDataPoint();
            }
            else if (value < previousValue)
            {
                // Slider is being slid to the left
                Debug.Log("Slider is moving to the left");
                RemoveDataPoint();
            }
