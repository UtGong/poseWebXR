...
{
    public class BarChartRealTime : MonoBehaviour
    {
        ...
        private void LoadDataAndUpdateChart()
        {
            ...
            //dataValues = new List<float> { 30f, 45f, 60f, 20f, 75f, 40f, 100f, 55f, 70f, 85f };

            // Randomize the dataValues list
            dataValues.Shuffle();
        ...
        private IEnumerator UpdateBarChart()
        {
            while (true)
            {
                LoadDataAndUpdateChart();
