...
{
    public class PieChart : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        public float[] dataPoints = new float[5]; // Array to store the data points (percentages)
        ...
        public RectTransform imageRectTransform; // Reference to the UI Image RectTransform
